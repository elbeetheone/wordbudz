from ._anvil_designer import Word_infoTemplate
from anvil import *
import anvil.server
from ..word_video import word_video
...
class Word_info(Word_infoTemplate):
  ...
  def link_1_click(self, **event_args):
    ...
    self.card_2.add_component(word_video(), full_width_row=True)
