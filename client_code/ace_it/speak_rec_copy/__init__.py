from ._anvil_designer import speak_rec_copyTemplate
from anvil import *
...
class speak_rec_copy(speak_rec_copyTemplate):
  def __init__(self, **properties):
    # Set Form properties and Data Bindings.
    self.init_components(**properties)
    self.user = anvil.server.call_s('test_cookie')
    self.questions = anvil.server.call('get_ai_questions', self.user)
  ...
  def button_2_click(self, **event_args):
    ...
    if self.button_2.text == 'Generate Report':
      ...
      url = anvil.server.call_s('get_sound', self.questions[0], 'curated') #closing speech
      ...
      self.button_1.enabled = False
      url = anvil.server.call_s('get_sound', self.questions[0], 'curated')
      self.call_js('loadClip', url)
